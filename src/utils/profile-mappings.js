...
const PROFILE_MAPPINGS = {
  ...
  'url-filtering':            { srxType: 'utm', srxAction: 'web-filtering', default: 'junos-wf-local-default', tier: 'A2' },
  ...
  'webfilter':            { srxType: 'utm', srxAction: 'web-filtering', default: 'junos-wf-local-default', tier: 'A2' },
  ...
  'webfilter-profile':    { srxType: 'utm', srxAction: 'web-filtering', default: 'junos-wf-local-default', tier: 'A2' },
